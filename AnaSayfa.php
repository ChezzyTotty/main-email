...
<?php
// 'header.php' dosyasını burada çağırın
include 'content/cookie.php';

// session_start() işlemini çağırın
session_start();
?>
...
<style>nav ul {
  text-align: left; /* Liste elemanlarını sola hizalar */
}

nav li {
  display: block; /* Liste elemanlarını blok element olarak düzenler */
}</style>
<body>
  <br />
  <div class="container">
    ...
    <main>
      ...
      <div class="process">
        <div class="box">
          ...
          <img src="https://readme-typing-svg.herokuapp.com?color=0EE6F7&lines=Css+%23%23%23%23%23%23%23%23%23+100%25"></img>
          <img src="https://readme-typing-svg.herokuapp.com?color=EFF727&lines=Javas+%23%23%23%23%23%23%23%23+100%25"></img>
          <img src="https://readme-typing-svg.herokuapp.com?color=8DF724&lines=Php+%23%23%23%23%23%23%23%23%23+100%25"></img>
          <img src="https://readme-typing-svg.herokuapp.com?color=1F25F7&lines=Python+%23%23%23%23%23%23%23%23+50%25"></img>
          <img src="https://readme-typing-svg.herokuapp.com?color=ff0000&lines=React+%23%23%23%23%23%23%23%23%23%23+40%25"></img>
          <img src="https://readme-typing-svg.herokuapp.com?color=234d5&lines=Sql+%23%23%23%23%23%23%23%23%23%23+30%25"></img>
  ...
  <style>
    ...
    #user-trigger {
      cursor: pointer;
      padding: 10px 20px;
      /* Dropdown menüyü daha kolay tıklanabilir hale getirmek için alan ekleyin */
    }

    #user-trigger:hover {
      background-color: #f0f0f0;
      /* Kullanıcı adı yanındaki alana hover efekti ekleyin */
    }
  ...
  <div id="menu">
    ...
    if (isset($_SESSION['username'])) {
      ...
      echo '<span id="user-trigger" class="menu-link" onclick="toggleMenu()"><strong>Merhaba, ' . $_SESSION['username'] . ' <i class="fa fa-caret-down"></strong></i></span>';
      ...
      echo '<a href="content/spoti.php" >Spotify</a>';
...
document.addEventListener("DOMContentLoaded", function() {
    var cleanDataButton = document.getElementById("clean-data-button");

    cleanDataButton.addEventListener("click", function() {
  ...
  <div id="myModal" class="modal">
    <div class="modal-content">
      <h2 style="color:#000000 ; font-weight: bold; ">İban Kopyalandı ve Yönlendiriliyor<span id="cursorlar">...</span>
      </h2>
  ...
  <script>
    ...
    function showNotification() {
      ...
      var url = "https://www.papara.com/" + encodeURIComponent(iban);
  ...
  <button onclick="showNotification()"><strong>Destek Olma</strong></button>
                        ...
                        <div id="smspanel-content">
                          ...
                          <div class="hidden">
                            <div id="about-content">
                              ...
                              <p>Merhaba,Ben <a href="https://www.instagram.com/ahmetserce06/" target="_blank">Ahmet
                                  Erdem</a> ,
                              ...
                              <p>
                                Hack işlemlerine birazcık ilgi duyuyorum ve uğraşıyorum kendi programım olmasada
                                <strong><span style="color: red;"> QUASAR RAT</span>
                                  ve <strong><span style="color: red;"> DARKCOMET</span> kullanarak Rat "Remote Access
                                    Trojan" ile uzaktan bilgisayar kontrolü ve işletimi
                                    yapabiliyorum.
                              </p>
                            ...
                            <div id="contact-content">
                              ...
                              <ul>
                                ...
                                <a href="https://www.discord.com/users/825484846205108295" target="_blank" class="social-button discord-button">
                                  <i class="fab fa-discord" aria-hidden="true"></i>
                                </a>
                                <a href="https://github.com/ChezzyTotty" target="_blank" class="social-button github-button">
                                  <i class="fab fa-github" aria-hidden="true"></i>
                                </a>
                                <a href="https://www.instagram.com/ahmetserce06/" target="_blank" class="social-button instagram-button">
                                  <i class="fab fa-instagram" aria-hidden="true"></i>
                                </a>

                                <a href="mailto:ahmeterdemserceoglo@gmail.com" class="social-button google-button">
                            ...
                            <div class="hidden">
                              ...
                              <div id="makineler-content">
                                ...
                                <ul>Kali Linux
                                  ...
                                  <ul>Parsus
                                    <p style="color: rgb(255, 8, 8);">Türk mühendisler tarafından geliştirilen TÜBİTAK
                                      projesi
